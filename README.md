...
- 🛡️ **Input Validation** — Request data validated before reaching business logic
...
- 🏗️ **Modular Architecture** — Organized into auth, user, and wallet modules
...
| **passport-jwt** | JWT token extraction & verification |
